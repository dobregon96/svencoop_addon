...
const int CSOW_DEFAULT_GIVE		= 80;
const int CSOW_MAX_AMMO		 	= 150;
const int CSOW_MAX_CLIP 		= 4;
const int CSOW_WEIGHT 			= 20;
const int CSOW_DAMAGE			= 30;
const uint CSOW_PELLETCOUNT		= 8;
...
const string MODEL_VIEW			= "models/scmod/weapons/ut99/shotty/v_qbarrel.mdl";
const string MODEL_PLAYER		= "models/xad_zubben/p_shotgun.mdl";
const string MODEL_WORLD		= "models/xad_zubben/w_shotgun.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"scmod/weapons/ut99/scock1.wav",
	"tfc/weapons/shotgn2.wav"
};
