...
const int MP5_DEFAULT_GIVE 	= 200;
const int MP5_MAX_AMMO		= 400;
const int MP5_MAX_AMMO2 	= 25;
const int MP5_MAX_CLIP 		= 200;
...
class weapon_hlmp5 : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/scmod/weapons/ut99/ar/w_9mmar.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/scmod/weapons/ut99/ar/v_9mmar.mdl" );
		g_Game.PrecacheModel( "models/scmod/weapons/ut99/ar/w_9mmar.mdl" );
		g_Game.PrecacheModel( "models/scmod/weapons/ut99/ar/p_9mmar.mdl" );

		m_iShell = g_Game.PrecacheModel( "models/shell_357.mdl" );

		g_Game.PrecacheModel( "models/scmod/weapons/ut99/biorifle/w_biomass.mdl" );

		g_Game.PrecacheModel( "models/scmod/weapons/ut99/w_9mmarclip.mdl" );
		g_SoundSystem.PrecacheSound( "scmod/weapons/ut99/9mmclip1.wav" );              

		//These are played by the model, needs changing there
		g_SoundSystem.PrecacheSound( "scmod/weapons/ut99/clipinsert1.wav" );
		g_SoundSystem.PrecacheSound( "scmod/weapons/ut99/gunpickup2.wav" );
		g_SoundSystem.PrecacheSound( "hl/weapons/357_cock1.wav" );

		g_SoundSystem.PrecacheSound( "scmod/weapons/ut99/hks1.wav" );

		g_SoundSystem.PrecacheSound( "scmod/weapons/ut99/glauncher.wav" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/scmod/weapons/ut99/ar/v_9mmar.mdl" ), self.GetP_Model( "models/scmod/weapons/ut99/ar/p_9mmar.mdl" ), MP5_DEPLOY, "mp5" );
	}
	...
	void PrimaryAttack()
	{
		...
		g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "scmod/weapons/ut99/hks1.wav", 1.0, ATTN_NORM, 0, 95 + Math.RandomLong( 0, 10 ) );
	...
	void SecondaryAttack()
	{
		...
		if ( g_PlayerFuncs.SharedRandomLong( m_pPlayer.random_seed, 0, 1 ) != 0 )
		{
			...
			g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "scmod/weapons/ut99/glauncher.wav", 0.8, ATTN_NORM, 0, PITCH_NORM );
		}
		else
		{
			// play this sound through BODY channel so we can hear it if player didn't stop firing MP5
...
void RegisterHLMP5()
{
	...
	g_ItemRegistry.RegisterWeapon( GetHLMP5Name(), "scmod/ut99", "9mm", "ARgrenades" );
}
