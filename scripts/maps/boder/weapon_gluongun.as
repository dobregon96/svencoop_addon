...
const string GLUONGUN_PLAYERMODEL 			= 					"models/custom_weapons/gluongun/schands/p_gluongun.mdl";
const string GLUONGUN_VIEWMODEL				=  					"models/custom_weapons/gluongun/schands/v_gluongun.mdl";
const string GLUONGUN_WORLDMODEL 			= 					"models/custom_weapons/gluongun/schands/w_gluongun.mdl";
...
void RegisterGluonGun()
{
	...
	g_ItemRegistry.RegisterWeapon( GetGluonGunName(), "scmod/superweapons", "gluoncells" );
}
