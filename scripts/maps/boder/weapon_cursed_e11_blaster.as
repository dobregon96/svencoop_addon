...
class weapon_cursed_e11 : ScriptBasePlayerWeaponEntity
{
	...
	void Spawn(){
		Precache();
		g_EntityFuncs.SetModel( self, "models/scmod/weapons/ut99/instagib/w_instagib.mdl" );
	...
	void Precache(){
		...
		g_Game.PrecacheModel( "sprites/disp_ring.spr" );
		g_Game.PrecacheModel( "models/scmod/weapons/ut99/instagib/v_instagib.mdl" );
		g_Game.PrecacheModel( "models/scmod/weapons/ut99/instagib/w_instagib.mdl" );
		g_Game.PrecacheModel( "models/scmod/weapons/ut99/instagib/p_instagib.mdl" );
		
		g_SoundSystem.PrecacheSound( "scmod/weapons/ut99/instagib.ogg" );
	}
	...
	bool Deploy(){
		return self.DefaultDeploy(
				self.GetV_Model( "models/scmod/weapons/ut99/instagib/v_instagib.mdl" ),
				self.GetP_Model( "models/scmod/weapons/ut99/instagib/p_instagib.mdl" ), E11_DEPLOY, "mp5"
		);
	}
	...
	void PrimaryAttack()
	{
		...
		g_SoundSystem.EmitSoundDyn( m_pPlayer.edict(), CHAN_WEAPON, "scmod/weapons/ut99/instagib.ogg", 1.0, ATTN_NORM, 0, 95 + Math.RandomLong( 0, 10 ) );
							...
							if( tr2.flFraction < 1.0 ){
								if( tr2.pHit !is null ){
									...
									if( pHit2 is null || pHit2.IsBSPModel() ){
										...
										if(boringTarget){
											//okok, you won!
											g_WeaponFuncs.DecalGunshot( tr1, DECAL_SCORCH1 );
											break;
										}
									}
								}
...
void RegisterHLE11()
{
	...
	g_ItemRegistry.RegisterWeapon( GetHLE11Name(), "scmod/ut99" );
}
