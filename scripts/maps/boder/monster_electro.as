...
class monster_electro : ScriptBaseMonsterEntity {
    ...
    void Spawn() {
        ...
        g_EntityFuncs.SetModel( self, "models/scmod/boderbot/richard_boderbot.mdl" );
    ...
    void Precache() {
        ...
        g_Game.PrecacheModel( "models/scmod/boderbot/richard_boderbot.mdl" );
        ...
        g_SoundSystem.PrecacheSound( "scmod/boderbot/dialogs/boderboss/hehehe.ogg" );
        g_SoundSystem.PrecacheSound( "fvox/buzz.wav");
        ...
        g_SoundSystem.PrecacheSound( "fvox/blip.wav");
        g_SoundSystem.PrecacheSound( "scientist/scream2.wav");
        g_SoundSystem.PrecacheSound( "scientist/scream5.wav");
        g_SoundSystem.PrecacheSound( "scientist/scream6.wav");
        g_SoundSystem.PrecacheSound( "scmod/boderbot/dialogs/boderboss/beanz.ogg");
    }
    ...
    void HandleAnimEvent( MonsterEvent@ pEvent ) {
        switch ( pEvent.event ) {
            case ELE_RANGE2:
            {
                g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "scientist/scream2.wav", 1, ATTN_NORM, 0, PITCH_NORM);
            ...
            case ELE_RANGE1:
            {
                ...
                ShootEleVolt(ent);                
                g_SoundSystem.EmitSoundDyn( self.edict(), CHAN_VOICE, "scmod/boderbot/dialogs/boderboss/hehehe.ogg", 1, ATTN_NORM, 0, PITCH_NORM);
