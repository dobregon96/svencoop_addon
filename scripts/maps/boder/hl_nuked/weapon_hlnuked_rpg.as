...
const int RPG_DEFAULT_GIVE 	= 6;
const int RPG_WEIGHT 		= 20;
const int RPG_MAX_CARRY 	= 48;
...
class CRpgRocket : ScriptBaseEntity
{
	...
	void Spawn()
	{
        ...
        g_EntityFuncs.SetModel( self, "models/scmod/weapons/ut99/rpgrocket.mdl");
    ...
    void Precache()
    {
		...
		g_Game.PrecacheModel( "models/scmod/weapons/ut99/rpgrocket.mdl" );
...
class weapon_hlnuked_rpg : ScriptBasePlayerWeaponEntity, weapon_base
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/scmod/weapons/ut99/rocket/w_rpg.mdl" ); // World model
	...
	void Precache()
	{
        ...
        g_Game.PrecacheModel("models/scmod/weapons/ut99/rocket/w_rpg.mdl"); // World model
        g_Game.PrecacheModel("models/scmod/weapons/ut99/rocket/v_rpg2.mdl"); // View model
        g_Game.PrecacheModel("models/scmod/weapons/ut99/rocket/p_rpg.mdl"); // Player model

		g_Game.PrecacheOther("hlnuked_rpg_rocket"); // Precache rocket entity

		g_SoundSystem.PrecacheSound("scmod/weapons/ut99/rocketfire1.wav"); // Rpg fire sound
		g_SoundSystem.PrecacheSound("scmod/weapons/ut99/rocketfire2.ogg"); // Rpg fire sound 2
		g_SoundSystem.PrecacheSound("hlnuked/rpg_deploy.wav"); // Rpg deploy sound

		g_Game.PrecacheGeneric("sprites/scmod/ut99/weapon_hlnuked_rpg.txt");
	...
	bool Deploy()
	{
		...
		return self.DefaultDeploy( self.GetV_Model( "models/scmod/weapons/ut99/rocket/v_rpg2.mdl" ), self.GetP_Model( "models/scmod/weapons/ut99/rocket/p_rpg.mdl" ), RPG_DRAW, "gauss" );
	...
	void PrimaryAttack()
	{
		...
		g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "scmod/weapons/ut99/rocketfire1.wav", 1, ATTN_NORM );
    ...
    void SecondaryAttack()
    {
		...
		g_SoundSystem.EmitSound( m_pPlayer.edict(), CHAN_WEAPON, "scmod/weapons/ut99/rocketfire2.ogg", 1, ATTN_NORM );
...
void RegisterHLNukedRpg()
{
	...
	g_ItemRegistry.RegisterWeapon( GetHLNukedRpgName(), "scmod/ut99", "rockets" );
}