...
const float CSOW_DAMAGE						= 46; //28?
const float CSOW_DAMAGE_RADIUS			= 95;
...
const float CSOW_PLASMA_SPEED				= 2048;
...
const string MODEL_VIEW							= "models/scmod/weapons/ut99/pulsegun/v_plasmagun.mdl";
const string MODEL_PLAYER						= "models/scmod/weapons/ut99/pulsegun/p_egon.mdl";
const string MODEL_WORLD						= "models/scmod/weapons/ut99/pulsegun/w_egon.mdl";
const string MODEL_AMMO						= "models/scmod/weapons/ut99/w_gaussclip.mdl";

const string SPRITE_PLASMA						= "sprites/greenglowa.spr";
const string SPRITE_EXPLODE					= "sprites/acid_puff2.spr";
...
//		m_bSwitchHands = true;
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/weapon_plasmagun.txt" );
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/pulse.spr" );
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/pulseammo.spr" );
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( "weapon_plasmagun", "scmod/ut99", "plasma", "", "ammo_plasmashell" );
}
