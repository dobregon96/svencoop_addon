...
const string MODEL_VIEW								= "models/scmod/weapons/ut99/stinger/v_stinger.mdl";
const string MODEL_VIEW_SCOPE					= "models/custom_weapons/cso/v_crossbow_scope.mdl";
const string MODEL_PLAYER							= "models/scmod/weapons/ut99/stinger/p_stinger.mdl";
const string MODEL_WORLD							= "models/scmod/weapons/ut99/stinger/w_stinger.mdl";
const string MODEL_BOLT								= "models/scmod/weapons/ut99/stinger/crystal_bolt.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"scmod/weapons/ut99/stinger_fire.ogg",
	"tfc/weapons/asscan3.wav",
	"tfc/weapons/ax1.wav",
	"tfc/weapons/sniper.wav",
	"tfc/weapons/asscan1.wav",
	"tfc/weapons/asscan4.wav",
	"tfc/items/health1.wav",
	"tfc/weapons/dartgun.wav",
	"tfc/weapons/spike1.wav",
	"tfc/weapons/spike2.wav"
...
class weapon_csocrossbow : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/" + CSOW_NAME + ".txt" );
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/stinger.spr" );
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/arrow.spr" );
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/crosshair.spr" );
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( CSOW_NAME, "scmod/ut99", "csobolts", "", "ammo_csobolts" );
