...
// Models
string W_MODEL		= "models/scmod/weapons/ut99/automag/w_automag.mdl";
string V_MODEL		= "models/scmod/weapons/ut99/automag/v_automag.mdl";
string P_MODEL		= "models/scmod/weapons/ut99/automag/p_automag.mdl";
string S_MODEL		= "models/shell_762.mdl"; // Change this manually in MapInit
// Sprites
string SPR_DIR		= "scmod/ut99/";
string LSR_SPR		= "sprites/laserdot.spr";
// Sounds
array<string> Sounds = { 
		"scmod/weapons/ut99/pl_gun3.wav",
		"weapons/desert_eagle_sight.wav",
		"weapons/desert_eagle_sight2.wav",
		"scmod/weapons/ut99/clipinsert1.wav",
		"hlclassic/weapons/357_cock1.wav",
		"scmod/weapons/ut99/9mmclip1.wav"
};
// Weapon information
int MAX_CARRY		= 100;
int MAX_CLIP		= 20;
...
int WEIGHT		= 15;
int FLAGS		= 0;
uint DAMAGE		= uint(g_EngineFuncs.CVarGetFloat("sk_plr_357_bullet")*0.60); // SC:2/3 of the magnum; OF:85% of the magnum, based on skillopfor.cfg ...Note: in practice "THATS A LOT OF DAMAGE!!", this translates strangely to hundreds of damage and even bypasses armor (can kill gargs, ospreys, apaches, etc) so I toned it down from 0.85 to 0.50
uint SLOT		= 1;
uint POSITION		= 9;
...
class weapon_ofeagle : ScriptBasePlayerWeaponEntity
{
	...
	void PrimaryAttack()
	{
		...
		{
			self.PlayEmptySound();
			self.m_flNextPrimaryAttack = WeaponTimeBase() + (self.m_iClip > 0 ? 0.15 : 0.4);
			return;
		}
