...
const string MODEL_VIEW								= "models/scmod/weapons/ut99/enforcers/v_elite.mdl";
const string MODEL_PLAYER							= "models/scmod/weapons/ut99/enforcers/p_elite.mdl";
const string MODEL_WORLD							= "models/scmod/weapons/ut99/enforcers/w_elite.mdl";
...
const array<string> pCSOWSounds =
{
	...
	"scmod/weapons/ut99/enforcer_fire.ogg",
...
class weapon_elites : CBaseCSOWeapon
{
	...
	void Precache()
	{
		...
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/enfammo.spr" );
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/enforcer1.spr" );
		g_Game.PrecacheGeneric( "sprites/scmod/ut99/enforcer2.spr" );
	}
	...
	bool GetItemInfo( ItemInfo& out info )
	{
		...
		info.iPosition		= cso::ELITES_POSITION - 3;
	...
	void ELITEFire( float flSpread, float flCycleTime )
	{
		...
		if( m_iWeaponState == STATE_LEFT )
		{
			...
			FireBullets3( m_pPlayer.GetGunPosition() - g_Engine.v_right * 5, g_Engine.v_forward, flSpread, iPenetration, BULLET_PLAYER_357, CSOW_TRACERFREQ, flDamage, 0.75, CSOF_ALWAYSDECAL );
...
void Register()
{
	...
	g_ItemRegistry.RegisterWeapon( CSOW_NAME, "scmod/ut99", "9mm", "", "ammo_9mmclip" );
}
