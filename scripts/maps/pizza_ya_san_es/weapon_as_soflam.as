...
class weapon_as_soflam : ScriptBasePlayerWeaponEntity {
    ...
    void Spawn() {
        Precache();
        g_EntityFuncs.SetModel( self, "models/pizza_ya_san_es/w_soflam.mdl" );
    ...
    void Precache() {
        ...
        g_Game.PrecacheModel( "models/pizza_ya_san_es/v_soflam.mdl" );
        g_Game.PrecacheModel( "models/pizza_ya_san_es/w_soflam.mdl" );
        g_Game.PrecacheModel( "models/pizza_ya_san_es/p_soflam.mdl" );
    ...
    bool Deploy() {
        ...
        return self.DefaultDeploy( self.GetV_Model( "models/pizza_ya_san_es/v_soflam.mdl" ), self.GetP_Model( "models/pizza_ya_san_es/p_soflam.mdl" ), SOFLAM_DRAW, "trip" );
    }
    ...
    void AirStrikeAttack(int &in strikeType) {
        ...
        if (ret) { 
            ...
            if (strikeType == 0) {
                g_PlayerFuncs.ClientPrint(m_pPlayer, HUD_PRINTCENTER, "Soporte de fuego solicitado!!\n\nA cubierto!!");
            } else {
                g_PlayerFuncs.ClientPrint(m_pPlayer, HUD_PRINTCENTER, "Soporte de fuego de amplio alcance solicitado!!\n\nA cubierto!!");
            }
        ...
        // 天井などで失敗している場合
            ...
            g_PlayerFuncs.ClientPrint(m_pPlayer, HUD_PRINTCENTER, "No se puede ejecutar el soporte de fuego aca!!");
        }
    }
...
void RegisterSoflam() {
    ...
    g_ItemRegistry.RegisterWeapon( GetSoflamName(), "pizza_ya_san_es", "rockets" );
}
