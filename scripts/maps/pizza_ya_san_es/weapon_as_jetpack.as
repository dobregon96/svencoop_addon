...
class weapon_as_jetpack : ScriptBasePlayerWeaponEntity {
    ...
    void Spawn() {
        Precache();
        g_EntityFuncs.SetModel( self, "models/pizza_ya_san_es/w_glock18jet.mdl" );
    ...
    void Precache() {
        ...
        g_Game.PrecacheModel( "models/pizza_ya_san_es/v_glock18jet.mdl" );
        g_Game.PrecacheModel( "models/pizza_ya_san_es/w_glock18jet.mdl" );
        g_Game.PrecacheModel( "models/pizza_ya_san_es/p_glock18jet.mdl" );
    ...
    bool Deploy() {
        m_iFuel = 0;
        m_iBurnSound = 0;
        return self.DefaultDeploy( self.GetV_Model( "models/pizza_ya_san_es/v_glock18jet.mdl" ), self.GetP_Model( "models/pizza_ya_san_es/p_glock18jet.mdl" ), GLOCK_DRAW, "onehanded" );
    }
    ...
    void Reload() {
        ...
        if ((WeaponTimeBase() > self.m_flNextPrimaryAttack) 
            ...
            g_PlayerFuncs.ClientPrint(m_pPlayer, HUD_PRINTCENTER, "Nivel de potencia: " + self.m_iClip);
        }
    }
...
void RegisterJetPack() {
    ...
    g_ItemRegistry.RegisterWeapon( GetJetPackName(), "pizza_ya_san_es", "9mm", "uranium" );
}
