 ...
 * @PointClass base(Weapon, Targetx, ExclusiveHold) studio("models/pizza_ya_san_es/w_shotgun_shorty.mdl") = weapon_as_shotgun : "custom shotgun" []
 */
...
class weapon_as_shotgun : ScriptBasePlayerWeaponEntity
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/pizza_ya_san_es/w_shotgun_shorty.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/pizza_ya_san_es/v_shotgun_shorty.mdl" );
		g_Game.PrecacheModel( "models/pizza_ya_san_es/w_shotgun_shorty.mdl" );
		g_Game.PrecacheModel( "models/pizza_ya_san_es/p_shotgun_shorty.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/pizza_ya_san_es/v_shotgun_shorty.mdl" ), self.GetP_Model( "models/pizza_ya_san_es/p_shotgun_shorty.mdl" ), SHOTGUN_DRAW, "shotgun" );
	}
...
void RegisterASShotgun()
{
	...
	g_ItemRegistry.RegisterWeapon( GetASShotgunName(), "pizza_ya_san_es", "buckshot" );
}
