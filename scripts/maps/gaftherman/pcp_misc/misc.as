namespace PCP_MISC 
{
    ...
    void SpawnCountHUDText(CBasePlayer@ pPlayer)
    {
        ...
        g_PlayerFuncs.HudMessage(pPlayer, SpawnCountHudText, 'Lives: ' + GetCKV(pPlayer,'$i_pcp_spawns'));
    }

    void CreatePlayerSpawnEffect(Vector pos)
    {
        CSprite@ m_pSprite = g_EntityFuncs.CreateSprite( 'sprites/singularity/prtl/kz_exit1.spr', pos, true, 10 );
        m_pSprite.TurnOn();
